...
public class proj_1 {
    ...
    public static void main(String[] args) {
        Notebook notebook1 = new Notebook("Lenovo", "4", "320", "Windows", "grey");
        Notebook notebook2 = new Notebook("Asus", "8", "500", "Linex", "black");
        Notebook notebook3 = new Notebook("Asus", "16", "1000", "Windows", "black");
        Notebook notebook4 = new Notebook("Msi", "16", "1000", "Windows", "grey");
        Notebook notebook5 = new Notebook("Apple", "8", "1000", "ios", "black");
